...
```
git clone https://github.com/vuejs-tailwindcss-portfolio.git
```
...
-   Coming Soon [I'll be doing a screencast](https://www.youtube.com/c/). Soon I'll be uploading a video to my YouTube channel where I'll be going through the process of creating this portoflio
